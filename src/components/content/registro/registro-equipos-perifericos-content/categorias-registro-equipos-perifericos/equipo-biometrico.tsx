...
import { RegistroEquipoBiometrico } from "@/types/registroEquiposPerifericos";

interface EquipoBiometricoProps {
    formData: RegistroEquipoBiometrico;
    handleInputChange: (
...
export default function EquipoBiometrico({ formData, handleInputChange, cancelForm, removerListenerBeforeUnload }: EquipoBiometricoProps) {
    const [seccionActiva, setSeccionActiva] = useState<"general" | "especificas">("general");
    
    const camposGeneralesEquipoBiometrico = [
        // Información General
        "sede",
        "nomOficina",
    ...
    const camposEspecificosEquipoBiometrico = [
        // Especificaciones Técnicas
        "capacidadUsuarios", "capacidadHuellas", "capacidadRostros", "capacidadTarjetas", "capacidadEventos",
        "pantalla", "fuenteAlimentacion",
    ];

    function validarCampos(formData: RegistroEquipoBiometrico, campos: string[]) {
        for (const campo of campos) {
            if (!formData[campo as keyof RegistroEquipoBiometrico]) {
            return false;
            }
        }
        return true;
    ...
    function handleNextSection() {
        if (!validarCampos(formData, camposGeneralesEquipoBiometrico)) {
    ...
    function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        e.preventDefault();
        if (!validarCampos(formData, camposEspecificosEquipoBiometrico)) {
    ...
    return (
        <>
            <h1 className="text-lg md:text-2xl font-bold text-center mb-6">Registro Físico y Lógico de Equipos Biométricos de MPP</h1>
                            ...
                            <div className="px-6 md:px-10 py-6">
                                <div className="mb-5">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-1 mb-5">
                                        <div className="flex flex-col lg:flex-row lg:items-center">
                                            <label htmlFor="capacidadUsuarios" className="text-sm md:text-base font-medium mb-1 lg:mb-0 lg:mr-3">Capacidad usuarios</label>
                                            <input type="number" id="capacidadUsuarios" name="capacidadUsuarios" required
                                                value={formData.capacidadUsuarios}
                                                onChange={handleInputChange}
                                                className="w-full p-2 border border-gray-300 text-sm md:text-base rounded-md focus:outline-none focus:ring-4" />
                                        </div>
                                        <div className="flex flex-col lg:flex-row lg:items-center">
                                            <label htmlFor="capacidadHuellas" className="text-sm md:text-base font-medium mb-1 lg:mb-0 lg:mr-3 whitespace-normal sm:whitespace-nowrap">Capacidad huellas</label>
                                            <input type="number" id="capacidadHuellas" name="capacidadHuellas" required
                                                value={formData.capacidadHuellas}
                                                onChange={handleInputChange}
                                                className="w-full p-2 border border-gray-300 text-sm md:text-base rounded-md focus:outline-none focus:ring-4" />
                                        </div>
                                        <div className="flex flex-col lg:flex-row lg:items-center">
                                            <label htmlFor="capacidadRostros" className="text-sm md:text-base font-medium mb-1 lg:mb-0 lg:mr-3">Capacidad rostros</label>
                                            <input type="number" id="capacidadRostros" name="capacidadRostros" required
                                                value={formData.capacidadRostros}
                                                onChange={handleInputChange}
                                                className="w-full p-2 border border-gray-300 text-sm md:text-base rounded-md focus:outline-none focus:ring-4" />
                                        </div>
                                        <div className="flex flex-col lg:flex-row lg:items-center">
                                            <label htmlFor="capacidadTarjetas" className="text-sm md:text-base font-medium mb-1 lg:mb-0 lg:mr-3 whitespace-normal sm:whitespace-nowrap">Capacidad tarjetas</label>
                                            <input type="number" id="capacidadTarjetas" name="capacidadTarjetas" required
                                                value={formData.capacidadTarjetas}
                                                onChange={handleInputChange}
                                                className="w-full p-2 border border-gray-300 text-sm md:text-base rounded-md focus:outline-none focus:ring-4" />
                                        </div>
                                        <div className="flex flex-col lg:flex-row lg:items-center">
                                            <label htmlFor="capacidadEventos" className="text-sm md:text-base font-medium mb-1 lg:mb-0 lg:mr-3">Capacidad eventos</label>
                                            <input type="number" id="capacidadEventos" name="capacidadEventos" required
                                                value={formData.capacidadEventos}
                                                onChange={handleInputChange}
                                                className="w-full p-2 border border-gray-300 text-sm md:text-base rounded-md focus:outline-none focus:ring-4" />
                                        </div>
                                        <div className="flex flex-col lg:flex-row lg:items-center">
                                ...
                                <div className="flex flex-col lg:flex-row lg:items-center mb-5">
                                    <label className="text-sm md:text-base font-medium mb-1 lg:mb-0 lg:mr-6 whitespace-normal sm:whitespace-nowrap">
                                        Comunicación
                                    </label>
                                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-7 lg:gap-16">
                                        <div className="flex items-center">
                                            <input type="checkbox" id="tcpIpComunicacion" name="tcpIpComunicacion"
                                                checked={formData.tcpIpComunicacion}
                                                onChange={handleInputChange} 
                                                className="w-4 h-4 accent-blue-600 cursor-pointer"
                                            />
                                            <label htmlFor="tcpIpComunicacion" className="ml-2">TCP/IP</label>
                                        </div>
                                        <div className="flex items-center">
                                            <input type="checkbox" id="usbComunicacion" name="usbComunicacion"
                                                ...
                                                className="w-4 h-4 accent-blue-600 cursor-pointer"
                                            />
                                            <label htmlFor="usbComunicacion" className="ml-2">USB</label>
                                        </div>
                                        <div className="flex items-center">
                                            <input type="checkbox" id="rs232Comunicacion" name="rs232Comunicacion"
                                                checked={formData.rs232Comunicacion}
                                                onChange={handleInputChange} 
                                                className="w-4 h-4 accent-blue-600 cursor-pointer"
                                            />
                                            <label htmlFor="rs232Comunicacion" className="ml-2">RS232/485</label>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex flex-col lg:flex-row lg:items-center mb-5">
                                ...
                                <div className="mb-6">
                                    <h1 className="text-base md:text-lg font-semibold">Interfaz de Acceso</h1>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-1">
                                        <div className="flex items-center border border-gray-300 rounded-md overflow-hidden mb-3">
                                            <div className="flex items-center bg-gray-200 px-3 py-2 border-r border-gray-300 w-10/12">
                                                <label htmlFor="cerraduraElectrica">
                                                    Cerradura eléctrica
                                                </label>
                                            </div>
                                            <div className="flex justify-center items-center w-2/12">
                                                <input type="checkbox" id="cerraduraElectrica" name="cerraduraElectrica"
                                                    checked={formData.cerraduraElectrica}
                                                    onChange={handleInputChange} 
                                                    className="w-4 h-4 accent-blue-600 cursor-pointer"/>
                                            </div>
                                        </div>
                                        <div className="flex items-center border border-gray-300 rounded-md overflow-hidden mb-3">
                                            <div className="flex items-center bg-gray-200 px-3 py-2 border-r border-gray-300 w-10/12">
                                                <label htmlFor="sensorPuerta">
                                                    Sensor de puerta
                                                </label>
                                            </div>
                                            <div className="flex justify-center items-center w-2/12">
                                                <input type="checkbox" id="sensorPuerta" name="sensorPuerta"
                                                    checked={formData.sensorPuerta}
                                                    onChange={handleInputChange}
                                                    className="w-4 h-4 accent-blue-600 cursor-pointer" />
                                            </div>
                                        </div>
                                        <div className="flex items-center border border-gray-300 rounded-md overflow-hidden mb-3">
                                            <div className="flex items-center bg-gray-200 px-3 py-2 border-r border-gray-300 w-10/12">
                                                <label htmlFor="botonSalida">
                                                    Botón de salida
                                                </label>
                                            </div>
                                            <div className="flex justify-center items-center w-2/12">
                                                <input type="checkbox" id="botonSalida" name="botonSalida"
                                                    checked={formData.botonSalida}
                                                    onChange={handleInputChange} 
                                                    className="w-4 h-4 accent-blue-600 cursor-pointer"/>
                                            </div>
                                        </div>
